...
#     # Add other custom objects here if any
# }
# with tf.keras.utils.custom_object_scope(custom_objects):
#     model = tf.keras.models.load_model('./models/chatbot.h5')

# model = TFBertForQuestionAnswering.from_pretrained('./models/chatbot.h5')
